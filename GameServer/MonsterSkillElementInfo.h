...
enum MONSTER_SKILL_ELEMENT_TYPE
{
	...
	MSE_TYPE_ICE_BREATH = 24,
	MSE_TYPE_ICE_BOOM = 25,
	MSE_TYPE_DEVIL_ICE= 26,
#endif
};
...
#if(GAMESERVER_UPDATE>=1200)//2018/05/25
	void ApplyElementIceBreathDamageAttack(int iIndex, int iTargetIndex);
	void ApplyElementIceBoomDamageAttack(int iIndex, int iTargetIndex);
	void  ApplyElementDevilIceDamageAttack(int iIndex, int iTargetIndex);
#endif
public:
