...
void CUnityBattleField::Load(char* section, char* path)
{
	this->m_bUBFEnable = 0; // = GetPrivateProfileInt(section, "IsBattleCoreEvent", 1, path);
}
...
void CUnityBattleField::SendUBFNotice(int aIndex)
{
	...
	//gEventInventory.GCEventInventoryEnableSend(aIndex, 3);
}
