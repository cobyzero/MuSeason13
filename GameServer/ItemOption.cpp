	...
	for(int n=0;n < MAX_SPECIAL;n++)
	{
		...
		switch(index)
		{
			...
			case ITEM_OPTION_ADD_DEFENSE_SUCCESS_RATE:
				lpObj->m_MPSkillOpt.DefenseSuccessRate += value;
				break;
			...
			case ITEM_OPTION_ADD_DEFENSIVE_FULL_HP_RESTORE_RATE:
				lpObj->m_MPSkillOpt.DefensiveFullHPRestoreRate += value;
				break;
			case ITEM_OPTION_ADD_DEFENSIVE_FULL_MP_RESTORE_RATE:
				lpObj->m_MPSkillOpt.DefensiveFullMPRestoreRate += value;
				break;
			...
			case ITEM_OPTION_MUL_DEFENSE:
				...
				break;
			case ITEM_OPTION_Resist_Double_Damage_Rate:
				lpObj->ResistDoubleDamageRate += value;
				break;
			case ITEM_OPTION_Resist_Ignore_Defense_Rate:
				lpObj->ResistIgnoreDefenseRate += value;
				break;
			case ITEM_OPTION_Resist_Ignore_Shield_Gauge_Rate:
				lpObj->ResistIgnoreShieldGaugeRate += value;
				break;
			case ITEM_OPTION_Resist_Critical_Damage_Rate:
				lpObj->ResistCriticalDamageRate += value;
				break;
			case ITEM_OPTION_Resist_Excellent_Damage_Rate:
				lpObj->ResistExcellentDamageRate += value;
				break;
			case ITEM_OPTION_Resist_Stun_Rate:
				lpObj->ResistStunRate += value;
				break;
			case ITEM_OPTION_ADD_MOVE_SPEED:
				lpObj->MoveSpeed += value;
				break;
			case ITEM_OPTION_ADD_MAGIC_DEFENSE:
				lpObj->MagicDefense += value;
				break;
			case ITEM_OPTION_ADD_QSX:
