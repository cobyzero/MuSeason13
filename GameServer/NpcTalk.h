...
public:
	...
	void NpcMonica(LPOBJ lpNpc,LPOBJ lpObj);
#endif
#if(GAMESERVER_UPDATE>=1000)//2017/02/28
	void NpcRheaGold(LPOBJ lpNpc,LPOBJ lpObj);
#endif
#if(GAMESERVER_UPDATE>=1200)//2018/01/19
	void NPCCent(LPOBJ lpNpc,LPOBJ lpObj);
#endif
};
