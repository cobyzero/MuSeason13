...
#include "MapItem.h"
#include "MapPath.h"
#if(GAMESERVER_UPDATE>=1220)//2017/05/22
#define MAX_MAP 160
#elif(GAMESERVER_UPDATE>=1200)//2017/05/22
#define MAX_MAP 116
...
enum eMapNumber
{
	...
	MAP_URQUE_HILL = 100,
	MAP_DURBAN_TYLER = 110,	
	MAP_FEREA =112,
	MAP_KNICKS = 113,
	MAP_QUEST_ZONE_ENTRANCE = 114,
	MAP_Labyrinth = 115,
...
public:
	...
	bool LabyrinthMoneyItemDrop(int aIndex, int money, int x, int y);
	int ReLoadMapAttr(const char *szFileName, WORD wMapNumber);
#endif
public:
	BYTE m_Weather;
