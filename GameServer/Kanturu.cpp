...
bool CKanturu::CheckEnterKanturu(int aIndex) // OK
{
	...
	if(lpObj->Inventory[lpObj->m_btInvenPetPos].m_Index == GET_ITEM(13,2))
#else
...
#if(GAMESERVER_UPDATE>=902)
	if(lpObj->Inventory[7].IsItem() == 0 && lpObj->Inventory[lpObj->m_btInvenPetPos].m_Index != GET_ITEM(13,3) && lpObj->Inventory[lpObj->m_btInvenPetPos].m_Index!= GET_ITEM(13,37))
#else
