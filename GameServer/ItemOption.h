...
enum eItemOption
{
	...
	ITEM_OPTION_Resist_Double_Damage_Rate = 128,
	ITEM_OPTION_Resist_Ignore_Defense_Rate = 129,
	ITEM_OPTION_Resist_Ignore_Shield_Gauge_Rate = 130,
	ITEM_OPTION_Resist_Critical_Damage_Rate = 131,
	ITEM_OPTION_Resist_Excellent_Damage_Rate = 132,
	ITEM_OPTION_Resist_Stun_Rate = 133,
	ITEM_OPTION_ADD_MOVE_SPEED = 134,
	ITEM_OPTION_ADD_MAGIC_DEFENSE = 135,
	ITEM_OPTION_ADD_QSX = 136, 
};
