...
enum eItemBagSpecialValue
{
	...
	ITEM_BGA_LABYRINTH1 =60,
	ITEM_BGA_LABYRINTH2 = 61,
	ITEM_BGA_LABYRINTH3 = 62,
	ITEM_BGA_LABYRINTH4 = 63,
	ITEM_BGA_LABYRINTH5 = 64,
	ITEM_BGA_LABYRINTH6 = 65,
	ITEM_BGA_LABYRINTH7 = 66,
};
...
public:
	...
	bool GremoryCaseDropItemBySpecialValue(int SpecialValue,BYTE btStorageType,BYTE btRewardSource,LPOBJ lpObj,int map,int x,int y);
