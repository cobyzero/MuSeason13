...
void CBloodCastle::GiveUserRewardItem(BLOOD_CASTLE_LEVEL* lpLevel,int aIndex) // OK
{
	...
	{
		case 0:
			gItemBagManager.GremoryCaseDropItemBySpecialValue(ITEM_BAG_BLOOD_CASTLE1,GC_STORAGE_CHARACTER,GC_REWARD_BLOOD_CASTLE,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
			break;
		case 1:
			gItemBagManager.GremoryCaseDropItemBySpecialValue(ITEM_BAG_BLOOD_CASTLE2,GC_STORAGE_CHARACTER,GC_REWARD_BLOOD_CASTLE,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
			break;
		case 2:
			gItemBagManager.GremoryCaseDropItemBySpecialValue(ITEM_BAG_BLOOD_CASTLE3,GC_STORAGE_CHARACTER,GC_REWARD_BLOOD_CASTLE,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
			break;
		case 3:
			gItemBagManager.GremoryCaseDropItemBySpecialValue(ITEM_BAG_BLOOD_CASTLE4,GC_STORAGE_CHARACTER,GC_REWARD_BLOOD_CASTLE,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
			break;
		case 4:
			gItemBagManager.GremoryCaseDropItemBySpecialValue(ITEM_BAG_BLOOD_CASTLE5,GC_STORAGE_CHARACTER,GC_REWARD_BLOOD_CASTLE,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
			break;
		case 5:
			gItemBagManager.GremoryCaseDropItemBySpecialValue(ITEM_BAG_BLOOD_CASTLE6,GC_STORAGE_CHARACTER,GC_REWARD_BLOOD_CASTLE,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
			break;
		case 6:
			gItemBagManager.GremoryCaseDropItemBySpecialValue(ITEM_BAG_BLOOD_CASTLE7,GC_STORAGE_CHARACTER,GC_REWARD_BLOOD_CASTLE,&gObj[lpUser->Index],gObj[lpUser->Index].Map,gObj[lpUser->Index].X,gObj[lpUser->Index].Y);
			break;
	}
}
