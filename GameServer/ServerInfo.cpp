...
void CServerInfo::ReadCashShopInfo() // OK
{
	...
	gCashShop.LoadPackage(gPath.GetRightPath("CashShop\\CashShopPackage.txt"));
	gCashShop.LoadProduct(gPath.GetRightPath("CashShop\\CashShopProduct.txt"));
...
void CServerInfo::ReadCharacterInfo() // OK
{
	...
	gDefaultClassInfo.Load(gPath.GetRightPath("Character\\DefaultClassInfo.txt"));
	g_StatSpec.Load(gPath.GetRightPath("Character\\StatSpecialize.txt"));
	g_StatSpec.ReadCharacterSpecialize(gPath.GetRightPath("Character\\StatSpecializeOption.dat"));
...
{
	gGameMaster.Load(gPath.GetRightPath("Commands\\GameMaster.txt"));
	gCommandManager.LoadCommands(gPath.GetRightPath("Commands\\Commands.txt"));
	gResetTable.Load(gPath.GetRightPath("Commands\\ResetTable.txt"));

	this->ReadCommandConfig();

	LogAdd(LOG_BLUE, "[ServerInfo] Commands config loaded successfully");
}
...
void CServerInfo::ReadCommonInfo() // OK
{
	...
	gEffectManager.Load(gPath.GetRightPath("Effect.txt"));
	gMapManager.Load(gPath.GetRightPath("MapManager.txt"));
	gMapServerManager.Load(gPath.GetRightPath("MapServerInfo.dat"));
	gMessage.Load(gPath.GetRightPath("Message.txt"));
	gMiniMap.Load(gPath.GetRightPath("MiniMap.txt"));
	gMiningSystem.Load(gPath.GetRightPath("Mining.txt"));

	gCRestoreSoldItem.LoadRestoreItemFlag();

	gCGHuntingGrounds.LoadHuntingRecordScript(gPath.GetRightPath("HuntingRecord.txt"));
	g_RuudTokenRewardProbability.Load_RuudBoxProbability(gPath.GetRightPath("RuudProbability.txt"));

	/*g_InstanceSystemMgr = new InstanceSystemMgr;
	g_InstanceSystemInfo.LoadInstanceSystemScript(gPath.GetRightPath("InstanceSystem.txt"));
	*/
...
void CServerInfo::ReadCustomInfo() // OK
{
	...
	gCustomArena.Load(gPath.GetRightPath("Custom\\CustomArena.txt"));

	gCustomEventDrop.Load(gPath.GetRightPath("Custom\\CustomEventDrop.txt"));

	gCustomJewel.Load(gPath.GetRightPath("Custom\\CustomJewel.txt"));

	gCustomMonster.Load(gPath.GetRightPath("Monster\\CustomMonster.txt"));

	gCustomWing.Load(gPath.GetRightPath("Custom\\CustomWing.txt"));
...
void CServerInfo::ReadEventInfo() // OK
{
	...
	gBloodCastle.Load(gPath.GetRightPath("Event\\BloodCastle.dat"));

	gBonusManager.Load(gPath.GetRightPath("Event\\BonusManager.dat"));

	gCastleDeep.Load(gPath.GetRightPath("Event\\CastleDeepEvent.dat"));

	gChaosCastle.Load(gPath.GetRightPath("Event\\ChaosCastle.dat"));

#if(GAMESERVER_TYPE==1)

	gCrywolf.Load(gPath.GetRightPath("Event\\Crywolf.dat"));

#endif

	gDevilSquare.Load(gPath.GetRightPath("Event\\DevilSquare.dat"));

	gDoubleGoer.Load(gPath.GetRightPath("Event\\DoubleGoer.dat"));

	gIllusionTemple.Load(gPath.GetRightPath("Event\\IllusionTemple.dat"));

	gImperialGuardian.Load(gPath.GetRightPath("Event\\ImperialGuardian.dat"));

	gInvasionManager.Load(gPath.GetRightPath("Event\\InvasionManager.dat"));

	gKanturu.Load(gPath.GetRightPath("Event\\Kanturu.dat"));

	gMossMerchant.Load(gPath.GetRightPath("Event\\MossMerchant.dat"));

	gRaklion.Load(gPath.GetRightPath("Event\\Raklion.dat"));

	gSummonScroll.Load(gPath.GetRightPath("Event\\SummonScroll.dat"));

	g_NixiesLakeBossZone.InitNixiesBossZone(0);

	//g_Labyrinth.LoadScript(gPath.GetRightPath("Event\\LabyrinthOfDimensionInfo.dat"));//2018/6/1

	g_UnityBattleField.Load("BattleCore", gPath.GetRightPath("Event\\BattleCore.dat"));

#if(GAMESERVER_TYPE==1)

	if (gCastleSiege.Ready(gMapServerManager.GetMapServerGroup()) != 0)
	{
		if (gCastleSiege.LoadData(gPath.GetRightPath("Event\\MuCastleData.dat")) != 0)
		{
	...
	fileName = gPath.GetRightPath("Event\\MUFCDamageIncrease.txt");

	if (gPath.CheckFileExists(".\\Data\\Event\\MUFCDamageIncrease.txt"))
	{
		fileName = ".\\Data\\Event\\MUFCDamageIncrease.txt";
	}

	gMUFC.Load(fileName);

	this->MUFC_Map = GetPrivateProfileInt("MUFC", "Map", 0, gPath.GetRightPath("Event\\MUFCConfig.ini"));
	this->MUFC_1_X = GetPrivateProfileInt("MUFC", "Fighter_1_X", 128, gPath.GetRightPath("Event\\MUFCConfig.ini"));
	this->MUFC_1_Y = GetPrivateProfileInt("MUFC", "Fighter_1_Y", 128, gPath.GetRightPath("Event\\MUFCConfig.ini"));
	this->MUFC_2_X = GetPrivateProfileInt("MUFC", "Fighter_2_X", 129, gPath.GetRightPath("Event\\MUFCConfig.ini"));
	this->MUFC_2_Y = GetPrivateProfileInt("MUFC", "Fighter_2_Y", 129, gPath.GetRightPath("Event\\MUFCConfig.ini"));

	this->MUFC_TimerToStart = GetPrivateProfileInt("MUFC", "TimerToStart", 3, gPath.GetRightPath("Event\\MUFCConfig.ini"));
	this->MUFC_TimerRound = GetPrivateProfileInt("MUFC", "TimerToReStart", 8, gPath.GetRightPath("Event\\MUFCConfig.ini"));
...
{
	gItemBagManager.Load(gPath.GetRightPath("EventItemBagManager.txt"));
...
void CServerInfo::ReadHackInfo() // OK
{
	...
	gHackPacketCheck.Load(gPath.GetRightPath("Hack\\HackPacketCheck.txt"));

	gPacketManager.LoadEncryptionKey(gPath.GetRightPath("Hack\\Enc2.dat"));

	gPacketManager.LoadDecryptionKey(gPath.GetRightPath("Hack\\Dec1.dat"));
...
{
	g380ItemOption.Load(gPath.GetRightPath("Item\\380ItemOption.txt"));

	g380ItemType.Load(gPath.GetRightPath("Item\\380ItemType.txt"));

	gItemManager.Load(gPath.GetRightPath("Item\\Item.txt"));

	gItemManager.LoadDamageRate(gPath.GetRightPath("Item\\ItemDamageRate.txt"));

	gItemDrop.Load(gPath.GetRightPath("Item\\ItemDrop.txt"));

	gItemMove.Load(gPath.GetRightPath("Item\\ItemMove.txt"));

	gItemOption.Load(gPath.GetRightPath("Item\\ItemOption.txt"));

	gItemOptionRate.Load(gPath.GetRightPath("Item\\ItemOptionRate.txt"));

	gItemStack.Load(gPath.GetRightPath("Item\\ItemStack.txt"));

	gItemValue.Load(gPath.GetRightPath("Item\\ItemValue.txt"));

	gGItemSlot.Load(gPath.GetRightPath("Item\\ItemSlot.txt"));

	gJewelOfHarmonyOption.Load(gPath.GetRightPath("Item\\JewelOfHarmonyOption.txt"));

	gJewelOfHarmonyType.Load(gPath.GetRightPath("Item\\JewelOfHarmonyType.txt"));

	gLuckyItem.Load(gPath.GetRightPath("Item\\LuckyItem.txt"));

	gMuunSystem.Load(gPath.GetRightPath("Item\\MuunOption.txt"));

	gPentagramSystem.Load(gPath.GetRightPath("Item\\PentagramOption.txt"));

	gPentagramSystem.LoadJewel(gPath.GetRightPath("Item\\PentagramJewelOption.txt"));

	gPentagramSystem.LoadMixRate(gPath.GetRightPath("Item\\PentagramJewelMixRate.txt"));

	gSetItemOption.Load(gPath.GetRightPath("Item\\SetItemOption.txt"));

	gSetItemType.Load(gPath.GetRightPath("Item\\SetItemType.txt"));

	gSocketItemOption.Load(gPath.GetRightPath("Item\\SocketItemOption.txt"));

	gSocketItemType.Load(gPath.GetRightPath("Item\\SocketItemType.txt"));

	gRheaGold.Load(gPath.GetRightPath("Item\\RuudShop.txt"));

	gMasteryItemExtOptionSet.Load(gPath.GetRightPath("Item\\MasteryItemExtOptionSet.txt"));

	gSocketChaos.Load(gPath.GetRightPath("Item\\SocketItemUp.txt"));
...
void CServerInfo::ReadMapInfo() // OK
{
	...
	for (int n = 0; n < MAX_MAP; n++)
	{
		...
		if (fopen_s(&file, gPath.GetRightPath(temp), "r") == 0)
		{
			strcpy_s(path, temp);
			fclose(file);
		}

		gMap[n].Load(gPath.GetRightPath(path), n);
	}

	gCrywolf.LoadCrywolfMapAttr(gPath.GetRightPath("Terrain\\terrain35_PEACE.att"), 0);

	gCrywolf.LoadCrywolfMapAttr(gPath.GetRightPath("Terrain\\terrain35_OCCUPIED.att"), 1);

	gCrywolf.LoadCrywolfMapAttr(gPath.GetRightPath("Terrain\\terrain35_WAR.att"), 2);

	gKanturu.LoadKanturuMapAttr(gPath.GetRightPath("Terrain\\terrain40_CLOSE.att"), 0);

	gKanturu.LoadKanturuMapAttr(gPath.GetRightPath("Terrain\\terrain40_OPEN.att"), 1);

	gWarehouse.LoadDynamicVault(gPath.GetRightPath("Item\\MultiVault.txt"));
}

void CServerInfo::ReadMonsterInfo() // OK
{
	gKanturuMonsterMng.Load(gPath.GetRightPath("Monster\\KanturuMonsterSetBase.txt"));
	CMonsterAIAutomata::LoadData(gPath.GetRightPath("Monster\\MonsterAIAutomata.txt"));
	CMonsterAIElement::LoadData(gPath.GetRightPath("Monster\\MonsterAIElement.txt"));
	CMonsterAIGroup::LoadData(gPath.GetRightPath("Monster\\MonsterAIGroup.txt"));
	CMonsterAIRule::LoadData(gPath.GetRightPath("Monster\\MonsterAIRule.txt"));
	CMonsterAIUnit::LoadData(gPath.GetRightPath("Monster\\MonsterAIUnit.txt"));	
	gMonsterManager.Load(gPath.GetRightPath("Monster\\Monster.txt"));
	gMonsterSetBase.Load(gPath.GetRightPath("Monster\\MonsterSetBase.txt"));
	CMonsterSkillElement::LoadData(gPath.GetRightPath("Monster\\MonsterSkillElement.txt"));
	CMonsterSkillUnit::LoadData(gPath.GetRightPath("Monster\\MonsterSkillUnit.txt"));
	CMonsterSkillManager::LoadData(gPath.GetRightPath("Monster\\MonsterSkill.txt"));
...
{
	gGate.Load(gPath.GetRightPath("Move\\Gate.txt"));
	gMove.Load(gPath.GetRightPath("Move\\Move.txt"));
	gMoveSummon.Load(gPath.GetRightPath("Move\\MoveSummon.txt"));
...
{
	gQuest.Load(gPath.GetRightPath("Quest\\Quest.txt"));
	gQuestObjective.Load(gPath.GetRightPath("Quest\\QuestObjective.txt"));
	gQuestReward.Load(gPath.GetRightPath("Quest\\QuestReward.txt"));
	gQuestWorld.Load(gPath.GetRightPath("QuestWorld\\QuestWorld.txt"));
	gQuestWorldObjective.Load(gPath.GetRightPath("QuestWorld\\QuestWorldObjective.txt"));
	gQuestWorldReward.Load(gPath.GetRightPath("QuestWorld\\QuestWorldReward.txt"));
	gNewQuestWorld.Load(gPath.GetRightPath("QuestWorld\\GuideQuest.txt"));
...
{
	gShopManager.Load(gPath.GetRightPath("ShopManager.txt"));
	gRheaGold.Load(gPath.GetRightPath("Item\\RuudShop.txt"));
...
void CServerInfo::ReadSkillInfo() // OK
{
	...
	gMasterSkillTree.Load(gPath.GetRightPath("Skill\\MasterSkillTree.txt"));

	gSkillHitBox.Load(gPath.GetRightPath("Skill\\SkillElect.hit"));

	gSkillManager.Load(gPath.GetRightPath("Skill\\Skill.txt"));

	gSkillManager.LoadSkillDamageRate(gPath.GetRightPath("Skill\\SkillDamageRate.txt"));

	gSkillManager.LoadSkillBlock(gPath.GetRightPath("Skill\\SkillBlock.txt"));

	g_ComboSkillPath.ReadSkillInfo("GameServerInfo", ".\\Data\\GameServerInfo - Skill.dat");

	gCalFormula.Load(gPath.GetRightPath("Skill\\FormulaData.txt"));

	gMasterSkillTree_4th.Load(gPath.GetRightPath("Skill\\ForSkillTree.txt"));
...
{
	gExperienceTable.Load(gPath.GetRightPath("Util\\ExperienceTable.txt"));
	gFilter.Load(gPath.GetRightPath("Util\\Filter.txt"));
	gNotice.Load(gPath.GetRightPath("Util\\Notice.txt"));
...
void CServerInfo::ReadStartupInfo(char* section, char* path) // OK
{
	...
	this->m_WriteItemDropLog = GetPrivateProfileInt(section, "WriteItemDropLog", 0, path);
	this->m_WriteItemBagLog = GetPrivateProfileInt(section, "WriteItemBagLog", 0, path);
	this->m_WriteItemUpgradeLog = GetPrivateProfileInt(section, "WriteItemUpgradeLog", 0, path);
	this->m_WriteStalkLog = GetPrivateProfileInt(section, "WriteStalkLog", 0, path);
	this->m_WriteHitQueueLog = GetPrivateProfileInt(section, "WriteHitQueueLog", 0, path);
}
...
{
	char GameServerInfo[100] = { 0 };
#if(GAMESERVER_UPDATE>=1200)//2017/05/26
	this->m_FEAngelMixRate = GetPrivateProfileInt(section, "FEAngelMixRate", 0, path);	//
	this->m_MGAngelMixRate = GetPrivateProfileInt(section, "MGAngelMixRate", 0, path);	//
#endif
#if(GAMESERVER_UPDATE>=1120)//2017/05/04 镶宝装备升级
	...
	this->m_ChaosDarkAngelLuckRate = GetPrivateProfileInt(section, "ChaosDarkAngelLuckRate", 0, path);	//暗黑天使套装合成幸运概率
	this->m_ChaosDarkAngelSet = GetPrivateProfileInt(section, "ChaosDarkAngelSet", 0, path);			//暗黑天使套装合成+15全属性几率
	this->m_ChaosAngelEcxMaxRate = GetPrivateProfileInt(section, "ChaosAngelEcxMaxRate", 0, path);			//全属性概率
	this->m_ChaosAngelLuckRate = GetPrivateProfileInt(section, "ChaosAngelLuckRate", 0, path);			//幸运概率
	this->m_ChaosDrakAngelInheritBloodAngelEcx = GetPrivateProfileInt(section, "ChaosDrakAngelInheritBloodAngelEcx", 0, path);

	this->m_AngelEcxAddSwitch = GetPrivateProfileInt(section, "AngelEcxAddSwitch", 0, path);			//是否开启卓越生成[关]:0[开]:1
	this->m_AngelEcxMaxOption = GetPrivateProfileInt(section, "AngelEcxMaxOption", 0, path);			//生成最大卓越属性
	...
	this->m_FeatherOfCondorMixRate[0] = GetPrivateProfileInt(section, "FeatherOfCondorMixRate_AL0", -1, path);

	this->m_FeatherOfCondorMixRate[1] = GetPrivateProfileInt(section, "FeatherOfCondorMixRate_AL1", -1, path);

	this->m_FeatherOfCondorMixRate[2] = GetPrivateProfileInt(section, "FeatherOfCondorMixRate_AL2", -1, path);

	this->m_FeatherOfCondorMixRate[3] = GetPrivateProfileInt(section, "FeatherOfCondorMixRate_AL3", -1, path);

	this->m_Wing3MixRate[0] = GetPrivateProfileInt(section, "Wing3MixRate_AL0", -1, path);
	this->m_Wing3MixRate[1] = GetPrivateProfileInt(section, "Wing3MixRate_AL1", -1, path);
	this->m_Wing3MixRate[2] = GetPrivateProfileInt(section, "Wing3MixRate_AL2", -1, path);
	this->m_Wing3MixRate[3] = GetPrivateProfileInt(section, "Wing3MixRate_AL3", -1, path);

	this->m_Wing4MixRate[0] = GetPrivateProfileInt(section, "Wing4MixRate_AL0", -1, path);
	this->m_Wing4MixRate[1] = GetPrivateProfileInt(section, "Wing4MixRate_AL1", -1, path);
	this->m_Wing4MixRate[2] = GetPrivateProfileInt(section, "Wing4MixRate_AL2", -1, path);
	this->m_Wing4MixRate[3] = GetPrivateProfileInt(section, "Wing4MixRate_AL3", -1, path);
...
void CServerInfo::ReadCharacterInfo(char* section, char* path) // OK
{
	...
	this->m_CriticalDamageRate = GetPrivateProfileInt(section, "CriticalDamageRate", 0, path);
	this->m_ExcellentDamageRate = GetPrivateProfileInt(section, "ExcellentDamageRate", 0, path);
	this->m_DamageReflect = GetPrivateProfileInt(section, "DamageReflect", 0, path);
	this->m_DamageReduction = GetPrivateProfileInt(section, "DamageReduction", 0, path);
	this->m_ShieldDamageReduction = GetPrivateProfileInt(section, "ShieldDamageReduction", 0, path);
	...
	this->m_DamageRatePvP[7] = GetPrivateProfileInt(section, "FKDamageRatePvP", 0, path);
	...
	this->m_DamageRatePvM[7] = GetPrivateProfileInt(section, "FKDamageRatePvM", 0, path);
...
#endif
#if(GAMESERVER_UPDATE>=1000)//2017/02/28
	this->m_DamageRateTo[0][7] = GetPrivateProfileInt(section, "DWDamageRateToGL", 0, path);
	this->m_DamageRateTo[1][7] = GetPrivateProfileInt(section, "DKDamageRateToGL", 0, path);
	this->m_DamageRateTo[2][7] = GetPrivateProfileInt(section, "FEDamageRateToGL", 0, path);
	this->m_DamageRateTo[3][7] = GetPrivateProfileInt(section, "MGDamageRateToGL", 0, path);
	this->m_DamageRateTo[4][7] = GetPrivateProfileInt(section, "DLDamageRateToGL", 0, path);
	this->m_DamageRateTo[5][7] = GetPrivateProfileInt(section, "SUDamageRateToGL", 0, path);
	this->m_DamageRateTo[6][7] = GetPrivateProfileInt(section, "RFDamageRateToGL", 0, path);

	this->m_DamageRateTo[7][0] = GetPrivateProfileInt(section, "FKDamageRateToDW", 0, path);

	this->m_DamageRateTo[7][1] = GetPrivateProfileInt(section, "FKDamageRateToDK", 0, path);

	this->m_DamageRateTo[7][2] = GetPrivateProfileInt(section, "FKDamageRateToFE", 0, path);

	this->m_DamageRateTo[7][3] = GetPrivateProfileInt(section, "FKDamageRateToMG", 0, path);

	this->m_DamageRateTo[7][4] = GetPrivateProfileInt(section, "FKDamageRateToDL", 0, path);

	this->m_DamageRateTo[7][5] = GetPrivateProfileInt(section, "FKDamageRateToSU", 0, path);

	this->m_DamageRateTo[7][6] = GetPrivateProfileInt(section, "FKDamageRateToRF", 0, path);

	this->m_DamageRateTo[7][7] = GetPrivateProfileInt(section, "FKDamageRateToGL", 0, path);
	...
	this->m_DamageStuckRate[7] = GetPrivateProfileInt(section, "FKDamageStuckRate", 0, path);
...
#endif
#if(GAMESERVER_UPDATE>=1000)//2017/02/28
	this->m_FKDamageMultiplierConstA = GetPrivateProfileInt(section, "FKDamageMultiplierConstA", 0, path);
	this->m_FKDamageMultiplierConstB = GetPrivateProfileInt(section, "FKDamageMultiplierConstB", 0, path);
	this->m_FKDamageMultiplierMaxRate = GetPrivateProfileInt(section, "FKDamageMultiplierMaxRate", 0, path);
#endif
	...
	this->m_HPRecoveryRate[7] = GetPrivateProfileInt(section, "FKHPRecoveryRate", 0, path);
	this->m_MPRecoveryRate[7] = GetPrivateProfileInt(section, "FKMPRecoveryRate", 0, path);
	this->m_BPRecoveryRate[7] = GetPrivateProfileInt(section, "FKBPRecoveryRate", 0, path);
	this->m_SDRecoveryRate[0] = GetPrivateProfileInt(section, "FKSDRecoveryRate", 0, path);
#endif
	...
	this->m_FKPlasmaStormDamageConstA = GetPrivateProfileInt(section, "FKPlasmaStormDamageConstA", 0, path);

	this->m_FKPlasmaStormDamageConstB = GetPrivateProfileInt(section, "FKPlasmaStormDamageConstB", 0, path);

	this->m_FKPlasmaStormDamageConstC = GetPrivateProfileInt(section, "FKPlasmaStormDamageConstC", 0, path);

	this->m_FKPlasmaStormDamageConstD = GetPrivateProfileInt(section, "FKPlasmaStormDamageConstD", 0, path);
...
#endif
#if(GAMESERVER_UPDATE>=1000)//2017/02/28
	this->m_FKPhysiDamageMinConstA = GetPrivateProfileInt(section, "FKPhysiDamageMinConstA", 0, path);

	this->m_FKPhysiDamageMaxConstA = GetPrivateProfileInt(section, "FKPhysiDamageMaxConstA", 0, path);

	this->m_FKPhysiDamageMinConstB = GetPrivateProfileInt(section, "FKPhysiDamageMinConstB", 0, path);

	this->m_FKPhysiDamageMaxConstB = GetPrivateProfileInt(section, "FKPhysiDamageMaxConstB", 0, path);

	this->m_FKMagicDamageMinConstA = GetPrivateProfileInt(section, "FKMagicDamageMinConstA", 0, path);

	this->m_FKMagicDamageMaxConstA = GetPrivateProfileInt(section, "FKMagicDamageMaxConstA", 0, path);


	this->m_FKAttackSuccessRateConstA = GetPrivateProfileInt(section, "FKAttackSuccessRateConstA", 0, path);

	this->m_FKAttackSuccessRateConstB = GetPrivateProfileInt(section, "FKAttackSuccessRateConstB", 0, path);

	this->m_FKAttackSuccessRateConstC = GetPrivateProfileInt(section, "FKAttackSuccessRateConstC", 0, path);

	this->m_FKAttackSuccessRateConstD = GetPrivateProfileInt(section, "FKAttackSuccessRateConstD", 0, path);


	this->m_FKAttackSuccessRatePvPConstA = GetPrivateProfileInt(section, "DKAttackSuccessRatePvPConstA", 0, path);

	this->m_FKAttackSuccessRatePvPConstB = GetPrivateProfileInt(section, "DKAttackSuccessRatePvPConstB", 0, path);

	this->m_FKAttackSuccessRatePvPConstC = GetPrivateProfileInt(section, "DKAttackSuccessRatePvPConstC", 0, path);

	this->m_FKAttackSuccessRatePvPConstD = GetPrivateProfileInt(section, "DKAttackSuccessRatePvPConstD", 0, path);
	...
	this->m_FKPhysiSpeedConstA = GetPrivateProfileInt(section, "FKPhysiSpeedConstA", 0, path);

	this->m_FKMagicSpeedConstA = GetPrivateProfileInt(section, "FKMagicSpeedConstA", 0, path);
	...
	this->m_FKDefenseSuccessRateConstA = GetPrivateProfileInt(section, "FKDefenseSuccessRateConstA", 0, path);
	...
	this->m_FKDefenseSuccessRatePvPConstA = GetPrivateProfileInt(section, "FKDefenseSuccessRatePvPConstA", 0, path);

	this->m_FKDefenseSuccessRatePvPConstB = GetPrivateProfileInt(section, "FKDefenseSuccessRatePvPConstB", 0, path);

	this->m_FKDefenseSuccessRatePvPConstC = GetPrivateProfileInt(section, "FKDefenseSuccessRatePvPConstC", 0, path);
	...
	this->m_FKDefenseConstA = GetPrivateProfileInt(section, "FKDefenseConstA", 0, path);

	this->m_ElementalDamageRatePvP[7] = GetPrivateProfileInt(section, "FKElementalDamageRatePvP", 0, path);

	this->m_ElementalDamageRatePvM[7] = GetPrivateProfileInt(section, "FKElementalDamageRatePvM", 0, path);
	...
	this->m_ElementalDamageRateTo[0][7] = GetPrivateProfileInt(section, "DWElementalDamageRateToGL", 0, path);
	this->m_ElementalDamageRateTo[1][7] = GetPrivateProfileInt(section, "DKElementalDamageRateToGL", 0, path);
	this->m_ElementalDamageRateTo[2][7] = GetPrivateProfileInt(section, "FEElementalDamageRateToGL", 0, path);
	this->m_ElementalDamageRateTo[3][7] = GetPrivateProfileInt(section, "MGElementalDamageRateToGL", 0, path);
	this->m_ElementalDamageRateTo[4][7] = GetPrivateProfileInt(section, "DLElementalDamageRateToGL", 0, path);
	this->m_ElementalDamageRateTo[5][7] = GetPrivateProfileInt(section, "SUElementalDamageRateToGL", 0, path);
	this->m_ElementalDamageRateTo[6][7] = GetPrivateProfileInt(section, "RFElementalDamageRateToGL", 0, path);

	this->m_ElementalDamageRateTo[7][0] = GetPrivateProfileInt(section, "FKElementalDamageRateToDW", 0, path);

	this->m_ElementalDamageRateTo[7][1] = GetPrivateProfileInt(section, "FKElementalDamageRateToDK", 0, path);

	this->m_ElementalDamageRateTo[7][2] = GetPrivateProfileInt(section, "FKElementalDamageRateToFE", 0, path);

	this->m_ElementalDamageRateTo[7][3] = GetPrivateProfileInt(section, "FKElementalDamageRateToMG", 0, path);

	this->m_ElementalDamageRateTo[7][4] = GetPrivateProfileInt(section, "FKElementalDamageRateToDL", 0, path);

	this->m_ElementalDamageRateTo[7][5] = GetPrivateProfileInt(section, "FKElementalDamageRateToSU", 0, path);

	this->m_ElementalDamageRateTo[7][6] = GetPrivateProfileInt(section, "FKElementalDamageRateToRF", 0, path);

	this->m_ElementalDamageRateTo[7][7] = GetPrivateProfileInt(section, "FKElementalDamageRateToGL", 0, path);


	this->m_FKElementalDefenseConstA = GetPrivateProfileInt(section, "FKElementalDefenseConstA", 0, path);

	this->m_FKElementalDamageMinConstA = GetPrivateProfileInt(section, "FKElementalDamageMinConstA", 0, path);

	this->m_FKElementalDamageMaxConstA = GetPrivateProfileInt(section, "FKElementalDamageMaxConstA", 0, path);
...
#if(GAMESERVER_UPDATE>=1000)//2017/02/28
	this->m_FKElementalAttackSuccessRateConstA = GetPrivateProfileInt(section, "FKElementalAttackSuccessRateConstA", 0, path);

	this->m_FKElementalAttackSuccessRateConstB = GetPrivateProfileInt(section, "FKElementalAttackSuccessRateConstB", 0, path);

	this->m_FKElementalAttackSuccessRateConstC = GetPrivateProfileInt(section, "FKElementalAttackSuccessRateConstC", 0, path);

	this->m_FKElementalAttackSuccessRateConstD = GetPrivateProfileInt(section, "FKElementalAttackSuccessRateConstD", 0, path);

	this->m_FKElementalDefenseSuccessRateConstA = GetPrivateProfileInt(section, "DWElementalDefenseSuccessRateConstA", 0, path);
...
void CServerInfo::ReadCommandConfig()
{
	this->m_CommandPostEnable[0] = GetPrivateProfileInt("POST", "Enable_AL0", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostEnable[1] = GetPrivateProfileInt("POST", "Enable_AL1", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostEnable[2] = GetPrivateProfileInt("POST", "Enable_AL2", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostEnable[3] = GetPrivateProfileInt("POST", "Enable_AL3", 0, gPath.GetRightPath("Commands\\Post.ini"));

	this->m_CommandPostLevel[0] = GetPrivateProfileInt("POST", "Level_AL0", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostLevel[1] = GetPrivateProfileInt("POST", "Level_AL1", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostLevel[2] = GetPrivateProfileInt("POST", "Level_AL2", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostLevel[3] = GetPrivateProfileInt("POST", "Level_AL3", 0, gPath.GetRightPath("Commands\\Post.ini"));

	this->m_CommandPostReset[0] = GetPrivateProfileInt("POST", "Reset_AL0", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostReset[1] = GetPrivateProfileInt("POST", "Reset_AL1", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostReset[2] = GetPrivateProfileInt("POST", "Reset_AL2", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostReset[3] = GetPrivateProfileInt("POST", "Reset_AL3", 0, gPath.GetRightPath("Commands\\Post.ini"));

	this->m_CommandPostMoney[0] = GetPrivateProfileInt("POST", "MoneyTax_AL0", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostMoney[1] = GetPrivateProfileInt("POST", "MoneyTax_AL1", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostMoney[2] = GetPrivateProfileInt("POST", "MoneyTax_AL2", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostMoney[3] = GetPrivateProfileInt("POST", "MoneyTax_AL3", 0, gPath.GetRightPath("Commands\\Post.ini"));

	this->m_CommandPostDelay[0] = GetPrivateProfileInt("POST", "Delay_AL0", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostDelay[1] = GetPrivateProfileInt("POST", "Delay_AL1", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostDelay[2] = GetPrivateProfileInt("POST", "Delay_AL2", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostDelay[3] = GetPrivateProfileInt("POST", "Delay_AL3", 0, gPath.GetRightPath("Commands\\Post.ini"));

	this->m_CommandPostGlobal[0] = GetPrivateProfileInt("POST", "Global_AL0", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostGlobal[1] = GetPrivateProfileInt("POST", "Global_AL1", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostGlobal[2] = GetPrivateProfileInt("POST", "Global_AL2", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostGlobal[3] = GetPrivateProfileInt("POST", "Global_AL3", 0, gPath.GetRightPath("Commands\\Post.ini"));

	this->m_CommandPostType[0] = GetPrivateProfileInt("POST", "Type_AL0", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostType[1] = GetPrivateProfileInt("POST", "Type_AL1", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostType[2] = GetPrivateProfileInt("POST", "Type_AL2", 0, gPath.GetRightPath("Commands\\Post.ini"));
	this->m_CommandPostType[3] = GetPrivateProfileInt("POST", "Type_AL3", 0, gPath.GetRightPath("Commands\\Post.ini"));

	/************************************************************************************************************************************/

	this->m_CommandAddPointEnable[0] = GetPrivateProfileInt("ADD", "Enable_AL0", 0, gPath.GetRightPath("Commands\\Add.ini"));
	this->m_CommandAddPointEnable[1] = GetPrivateProfileInt("ADD", "Enable_AL1", 0, gPath.GetRightPath("Commands\\Add.ini"));
	this->m_CommandAddPointEnable[2] = GetPrivateProfileInt("ADD", "Enable_AL2", 0, gPath.GetRightPath("Commands\\Add.ini"));
	this->m_CommandAddPointEnable[3] = GetPrivateProfileInt("ADD", "Enable_AL3", 0, gPath.GetRightPath("Commands\\Add.ini"));

	this->m_CommandAddPointAutoEnable[0] = GetPrivateProfileInt("ADD", "AutoAddEnable_AL0", 0, gPath.GetRightPath("Commands\\Add.ini"));
	this->m_CommandAddPointAutoEnable[1] = GetPrivateProfileInt("ADD", "AutoAddEnable_AL1", 0, gPath.GetRightPath("Commands\\Add.ini"));
	this->m_CommandAddPointAutoEnable[2] = GetPrivateProfileInt("ADD", "AutoAddEnable_AL2", 0, gPath.GetRightPath("Commands\\Add.ini"));
	this->m_CommandAddPointAutoEnable[3] = GetPrivateProfileInt("ADD", "AutoAddEnable_AL3", 0, gPath.GetRightPath("Commands\\Add.ini"));

	this->m_CommandAddPointMoney[0] = GetPrivateProfileInt("ADD", "MoneyTax_AL0", 0, gPath.GetRightPath("Commands\\Add.ini"));
	this->m_CommandAddPointMoney[1] = GetPrivateProfileInt("ADD", "MoneyTax_AL1", 0, gPath.GetRightPath("Commands\\Add.ini"));
	this->m_CommandAddPointMoney[2] = GetPrivateProfileInt("ADD", "MoneyTax_AL2", 0, gPath.GetRightPath("Commands\\Add.ini"));
	this->m_CommandAddPointMoney[3] = GetPrivateProfileInt("ADD", "MoneyTax_AL3", 0, gPath.GetRightPath("Commands\\Add.ini"));

	/**********************************************************************************************************************************/
	
	this->m_CommandPKClearEnable[0] = GetPrivateProfileInt("PKCLEAR", "Enable_AL0", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearEnable[1] = GetPrivateProfileInt("PKCLEAR", "Enable_AL1", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearEnable[2] = GetPrivateProfileInt("PKCLEAR", "Enable_AL2", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearEnable[3] = GetPrivateProfileInt("PKCLEAR", "Enable_AL3", 0, gPath.GetRightPath("Commands\\PkClear.ini"));

	this->m_CommandPKClearMoney[0] = GetPrivateProfileInt("PKCLEAR", "MoneyTax_AL0", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearMoney[1] = GetPrivateProfileInt("PKCLEAR", "MoneyTax_AL1", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearMoney[2] = GetPrivateProfileInt("PKCLEAR", "MoneyTax_AL2", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearMoney[3] = GetPrivateProfileInt("PKCLEAR", "MoneyTax_AL3", 0, gPath.GetRightPath("Commands\\PkClear.ini"));

	this->m_CommandPKClearGoblinPoint[0] = GetPrivateProfileInt("PKCLEAR", "GoblinPointTax_AL0", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearGoblinPoint[1] = GetPrivateProfileInt("PKCLEAR", "GoblinPointTax_AL1", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearGoblinPoint[2] = GetPrivateProfileInt("PKCLEAR", "GoblinPointTax_AL2", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearGoblinPoint[3] = GetPrivateProfileInt("PKCLEAR", "GoblinPointTax_AL3", 0, gPath.GetRightPath("Commands\\PkClear.ini"));

	this->m_CommandPKClearWCoinP[0] = GetPrivateProfileInt("PKCLEAR", "WCoinPTax_AL0", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearWCoinP[1] = GetPrivateProfileInt("PKCLEAR", "WCoinPTax_AL1", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearWCoinP[2] = GetPrivateProfileInt("PKCLEAR", "WCoinPTax_AL2", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearWCoinP[3] = GetPrivateProfileInt("PKCLEAR", "WCoinPTax_AL3", 0, gPath.GetRightPath("Commands\\PkClear.ini"));

	this->m_CommandPKClearWCoinC[0] = GetPrivateProfileInt("PKCLEAR", "WCoinCTax_AL0", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearWCoinC[1] = GetPrivateProfileInt("PKCLEAR", "WCoinCTax_AL1", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearWCoinC[2] = GetPrivateProfileInt("PKCLEAR", "WCoinCTax_AL2", 0, gPath.GetRightPath("Commands\\PkClear.ini"));
	this->m_CommandPKClearWCoinC[3] = GetPrivateProfileInt("PKCLEAR", "WCoinCTax_AL3", 0, gPath.GetRightPath("Commands\\PkClear.ini"));

	/**************************************************************************************************************************************/

	this->m_CommandRebuildEnable[0] = GetPrivateProfileInt("REBUILD", "Enable_AL0", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildEnable[1] = GetPrivateProfileInt("REBUILD", "Enable_AL1", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildEnable[2] = GetPrivateProfileInt("REBUILD", "Enable_AL2", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildEnable[3] = GetPrivateProfileInt("REBUILD", "Enable_AL3", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));

	this->m_CommandRebuildMoney[0] = GetPrivateProfileInt("REBUILD", "MoneyTax_AL0", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildMoney[1] = GetPrivateProfileInt("REBUILD", "MoneyTax_AL1", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildMoney[2] = GetPrivateProfileInt("REBUILD", "MoneyTax_AL2", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildMoney[3] = GetPrivateProfileInt("REBUILD", "MoneyTax_AL3", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));

	this->m_CommandRebuildGP[0] = GetPrivateProfileInt("REBUILD", "GoblinPoint_AL0", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildGP[1] = GetPrivateProfileInt("REBUILD", "GoblinPoint_AL1", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildGP[2] = GetPrivateProfileInt("REBUILD", "GoblinPoint_AL2", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildGP[3] = GetPrivateProfileInt("REBUILD", "GoblinPoint_AL3", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));

	this->m_CommandRebuildWP[0] = GetPrivateProfileInt("REBUILD", "WCoinPTax_AL0", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildWP[1] = GetPrivateProfileInt("REBUILD", "WCoinPTax_AL1", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildWP[2] = GetPrivateProfileInt("REBUILD", "WCoinPTax_AL2", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildWP[3] = GetPrivateProfileInt("REBUILD", "WCoinPTax_AL3", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));

	this->m_CommandRebuildWC[0] = GetPrivateProfileInt("REBUILD", "WCoinCTax_AL0", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildWC[1] = GetPrivateProfileInt("REBUILD", "WCoinCTax_AL1", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildWC[2] = GetPrivateProfileInt("REBUILD", "WCoinCTax_AL2", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));
	this->m_CommandRebuildWC[3] = GetPrivateProfileInt("REBUILD", "WCoinCTax_AL3", 0, gPath.GetRightPath("Commands\\Rebuild.ini"));

	/************************************************************************************************************************************/

	this->m_CommandChangeEnable[0] = GetPrivateProfileInt("EVO", "Enable_AL0", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeEnable[1] = GetPrivateProfileInt("EVO", "Enable_AL1", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeEnable[2] = GetPrivateProfileInt("EVO", "Enable_AL2", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeEnable[3] = GetPrivateProfileInt("EVO", "Enable_AL3", 0, gPath.GetRightPath("Commands\\Evo.ini"));

	this->m_CommandChangeMoney[0] = GetPrivateProfileInt("EVO", "MoneyTax_AL0", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeMoney[1] = GetPrivateProfileInt("EVO", "MoneyTax_AL1", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeMoney[2] = GetPrivateProfileInt("EVO", "MoneyTax_AL2", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeMoney[3] = GetPrivateProfileInt("EVO", "MoneyTax_AL3", 0, gPath.GetRightPath("Commands\\Evo.ini"));

	this->m_CommandChangeGP[0] = GetPrivateProfileInt("EVO", "GoblinPoint_AL0", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeGP[1] = GetPrivateProfileInt("EVO", "GoblinPoint_AL1", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeGP[2] = GetPrivateProfileInt("EVO", "GoblinPoint_AL2", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeGP[3] = GetPrivateProfileInt("EVO", "GoblinPoint_AL3", 0, gPath.GetRightPath("Commands\\Evo.ini"));

	this->m_CommandChangeWP[0] = GetPrivateProfileInt("EVO", "WCoinPTax_AL0", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeWP[1] = GetPrivateProfileInt("EVO", "WCoinPTax_AL1", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeWP[2] = GetPrivateProfileInt("EVO", "WCoinPTax_AL2", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeWP[3] = GetPrivateProfileInt("EVO", "WCoinPTax_AL3", 0, gPath.GetRightPath("Commands\\Evo.ini"));

	this->m_CommandChangeWC[0] = GetPrivateProfileInt("EVO", "WCoinCTax_AL0", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeWC[1] = GetPrivateProfileInt("EVO", "WCoinCTax_AL1", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeWC[2] = GetPrivateProfileInt("EVO", "WCoinCTax_AL2", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeWC[3] = GetPrivateProfileInt("EVO", "WCoinCTax_AL3", 0, gPath.GetRightPath("Commands\\Evo.ini"));

	this->m_CommandChangeLimit[0] = GetPrivateProfileInt("EVO", "CommandChangeLimit_AL0", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeLimit[1] = GetPrivateProfileInt("EVO", "CommandChangeLimit_AL1", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeLimit[2] = GetPrivateProfileInt("EVO", "CommandChangeLimit_AL2", 0, gPath.GetRightPath("Commands\\Evo.ini"));
	this->m_CommandChangeLimit[3] = GetPrivateProfileInt("EVO", "CommandChangeLimit_AL3", 0, gPath.GetRightPath("Commands\\Evo.ini"));

	/***********************************************************************************************************************************/

	this->m_CommandWareEnable[0] = GetPrivateProfileInt("WARE", "Enable_AL0", 0, gPath.GetRightPath("Commands\\Ware.ini"));
	this->m_CommandWareEnable[1] = GetPrivateProfileInt("WARE", "Enable_AL1", 0, gPath.GetRightPath("Commands\\Ware.ini"));
	this->m_CommandWareEnable[2] = GetPrivateProfileInt("WARE", "Enable_AL2", 0, gPath.GetRightPath("Commands\\Ware.ini"));
	this->m_CommandWareEnable[3] = GetPrivateProfileInt("WARE", "Enable_AL3", 0, gPath.GetRightPath("Commands\\Ware.ini"));

	this->m_CommandWareNumber[0] = GetPrivateProfileInt("WARE", "Limit_AL0", 0, gPath.GetRightPath("Commands\\Ware.ini"));
	this->m_CommandWareNumber[1] = GetPrivateProfileInt("WARE", "Limit_AL1", 0, gPath.GetRightPath("Commands\\Ware.ini"));
	this->m_CommandWareNumber[2] = GetPrivateProfileInt("WARE", "Limit_AL2", 0, gPath.GetRightPath("Commands\\Ware.ini"));
	this->m_CommandWareNumber[3] = GetPrivateProfileInt("WARE", "Limit_AL3", 0, gPath.GetRightPath("Commands\\Ware.ini"));

	/************************************************************************************************************************************/

	this->m_CommandResetType = GetPrivateProfileInt("RESET", "Type", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetEnable[0] = GetPrivateProfileInt("RESET", "Enable_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetEnable[1] = GetPrivateProfileInt("RESET", "Enable_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetEnable[2] = GetPrivateProfileInt("RESET", "Enable_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetEnable[3] = GetPrivateProfileInt("RESET", "Enable_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetAutoEnable[0] = GetPrivateProfileInt("RESET", "AutoResetEnable_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetAutoEnable[1] = GetPrivateProfileInt("RESET", "AutoResetEnable_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetAutoEnable[2] = GetPrivateProfileInt("RESET", "AutoResetEnable_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetAutoEnable[3] = GetPrivateProfileInt("RESET", "AutoResetEnable_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetCheckItem[0] = GetPrivateProfileInt("RESET", "CheckItem_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetCheckItem[1] = GetPrivateProfileInt("RESET", "CheckItem_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetCheckItem[2] = GetPrivateProfileInt("RESET", "CheckItem_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetCheckItem[3] = GetPrivateProfileInt("RESET", "CheckItem_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetMove[0] = GetPrivateProfileInt("RESET", "Move_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetMove[1] = GetPrivateProfileInt("RESET", "Move_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetMove[2] = GetPrivateProfileInt("RESET", "Move_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetMove[3] = GetPrivateProfileInt("RESET", "Move_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetQuest[0] = GetPrivateProfileInt("RESET", "Quest_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetQuest[1] = GetPrivateProfileInt("RESET", "Quest_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetQuest[2] = GetPrivateProfileInt("RESET", "Quest_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetQuest[3] = GetPrivateProfileInt("RESET", "Quest_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetSkill[0] = GetPrivateProfileInt("RESET", "Skill_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetSkill[1] = GetPrivateProfileInt("RESET", "Skill_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetSkill[2] = GetPrivateProfileInt("RESET", "Skill_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetSkill[3] = GetPrivateProfileInt("RESET", "Skill_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetLevel[0] = GetPrivateProfileInt("RESET", "Level_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLevel[1] = GetPrivateProfileInt("RESET", "Level_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLevel[2] = GetPrivateProfileInt("RESET", "Level_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLevel[3] = GetPrivateProfileInt("RESET", "Level_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetMoney[0] = GetPrivateProfileInt("RESET", "MoneyTax_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetMoney[1] = GetPrivateProfileInt("RESET", "MoneyTax_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetMoney[2] = GetPrivateProfileInt("RESET", "MoneyTax_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetMoney[3] = GetPrivateProfileInt("RESET", "MoneyTax_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetCount[0] = GetPrivateProfileInt("RESET", "Count_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetCount[1] = GetPrivateProfileInt("RESET", "Count_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetCount[2] = GetPrivateProfileInt("RESET", "Count_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetCount[3] = GetPrivateProfileInt("RESET", "Count_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetLimit[0] = GetPrivateProfileInt("RESET", "Limit_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimit[1] = GetPrivateProfileInt("RESET", "Limit_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimit[2] = GetPrivateProfileInt("RESET", "Limit_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimit[3] = GetPrivateProfileInt("RESET", "Limit_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetLimitDay[0] = GetPrivateProfileInt("RESET", "LimitDay_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimitDay[1] = GetPrivateProfileInt("RESET", "LimitDay_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimitDay[2] = GetPrivateProfileInt("RESET", "LimitDay_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimitDay[3] = GetPrivateProfileInt("RESET", "LimitDay_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetLimitWek[0] = GetPrivateProfileInt("RESET", "LimitWek_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimitWek[1] = GetPrivateProfileInt("RESET", "LimitWek_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimitWek[2] = GetPrivateProfileInt("RESET", "LimitWek_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimitWek[3] = GetPrivateProfileInt("RESET", "LimitWek_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetLimitMon[0] = GetPrivateProfileInt("RESET", "LimitMon_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimitMon[1] = GetPrivateProfileInt("RESET", "LimitMon_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimitMon[2] = GetPrivateProfileInt("RESET", "LimitMon_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetLimitMon[3] = GetPrivateProfileInt("RESET", "LimitMon_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetStartLevel[0] = GetPrivateProfileInt("RESET", "StartLevel_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetStartLevel[1] = GetPrivateProfileInt("RESET", "StartLevel_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetStartLevel[2] = GetPrivateProfileInt("RESET", "StartLevel_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetStartLevel[3] = GetPrivateProfileInt("RESET", "StartLevel_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetStartMasterLevel[0] = GetPrivateProfileInt("RESET", "StartMasterLevel_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetStartMasterLevel[1] = GetPrivateProfileInt("RESET", "StartMasterLevel_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetStartMasterLevel[2] = GetPrivateProfileInt("RESET", "StartMasterLevel_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetStartMasterLevel[3] = GetPrivateProfileInt("RESET", "StartMasterLevel_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetPoint[0] = GetPrivateProfileInt("RESET", "Point_AL0", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetPoint[1] = GetPrivateProfileInt("RESET", "Point_AL1", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetPoint[2] = GetPrivateProfileInt("RESET", "Point_AL2", 0, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetPoint[3] = GetPrivateProfileInt("RESET", "Point_AL3", 0, gPath.GetRightPath("Commands\\Reset.ini"));

	this->m_CommandResetPointRate[0] = GetPrivateProfileInt("RESET", "PointRateDW", 100, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetPointRate[1] = GetPrivateProfileInt("RESET", "PointRateDK", 100, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetPointRate[2] = GetPrivateProfileInt("RESET", "PointRateFE", 100, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetPointRate[3] = GetPrivateProfileInt("RESET", "PointRateMG", 100, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetPointRate[4] = GetPrivateProfileInt("RESET", "PointRateDL", 100, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetPointRate[5] = GetPrivateProfileInt("RESET", "PointRateSU", 100, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetPointRate[6] = GetPrivateProfileInt("RESET", "PointRateRF", 100, gPath.GetRightPath("Commands\\Reset.ini"));
	this->m_CommandResetPointRate[7] = GetPrivateProfileInt("RESET", "PointRateGL", 100, gPath.GetRightPath("Commands\\Reset.ini"));

	/*************************************************************************************************************************************/

	this->m_CommandMasterResetType = GetPrivateProfileInt("MASTERRESET", "Type", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetEnable[0] = GetPrivateProfileInt("MASTERRESET", "Enable_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetEnable[1] = GetPrivateProfileInt("MASTERRESET", "Enable_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetEnable[2] = GetPrivateProfileInt("MASTERRESET", "Enable_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetEnable[3] = GetPrivateProfileInt("MASTERRESET", "Enable_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetCheckItem[0] = GetPrivateProfileInt("MASTERRESET", "CheckItem_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetCheckItem[1] = GetPrivateProfileInt("MASTERRESET", "CheckItem_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetCheckItem[2] = GetPrivateProfileInt("MASTERRESET", "CheckItem_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetCheckItem[3] = GetPrivateProfileInt("MASTERRESET", "CheckItem_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetMove[0] = GetPrivateProfileInt("MASTERRESET", "Move_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetMove[1] = GetPrivateProfileInt("MASTERRESET", "Move_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetMove[2] = GetPrivateProfileInt("MASTERRESET", "Move_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetMove[3] = GetPrivateProfileInt("MASTERRESET", "Move_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetQuest[0] = GetPrivateProfileInt("MASTERRESET", "Quest_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetQuest[1] = GetPrivateProfileInt("MASTERRESET", "Quest_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetQuest[2] = GetPrivateProfileInt("MASTERRESET", "Quest_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetQuest[3] = GetPrivateProfileInt("MASTERRESET", "Quest_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetSkill[0] = GetPrivateProfileInt("MASTERRESET", "Skill_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetSkill[1] = GetPrivateProfileInt("MASTERRESET", "Skill_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetSkill[2] = GetPrivateProfileInt("MASTERRESET", "Skill_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetSkill[3] = GetPrivateProfileInt("MASTERRESET", "Skill_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetLevel[0] = GetPrivateProfileInt("MASTERRESET", "Level_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLevel[1] = GetPrivateProfileInt("MASTERRESET", "Level_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLevel[2] = GetPrivateProfileInt("MASTERRESET", "Level_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLevel[3] = GetPrivateProfileInt("MASTERRESET", "Level_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetReset[0] = GetPrivateProfileInt("MASTERRESET", "Reset_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetReset[1] = GetPrivateProfileInt("MASTERRESET", "Reset_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetReset[2] = GetPrivateProfileInt("MASTERRESET", "Reset_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetReset[3] = GetPrivateProfileInt("MASTERRESET", "Reset_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetMoney[0] = GetPrivateProfileInt("MASTERRESET", "MoneyTax_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetMoney[1] = GetPrivateProfileInt("MASTERRESET", "MoneyTax_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetMoney[2] = GetPrivateProfileInt("MASTERRESET", "MoneyTax_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetMoney[3] = GetPrivateProfileInt("MASTERRESET", "MoneyTax_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetCount[0] = GetPrivateProfileInt("MASTERRESET", "Count_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetCount[1] = GetPrivateProfileInt("MASTERRESET", "Count_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetCount[2] = GetPrivateProfileInt("MASTERRESET", "Count_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetCount[3] = GetPrivateProfileInt("MASTERRESET", "Count_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetLimit[0] = GetPrivateProfileInt("MASTERRESET", "Limit_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimit[1] = GetPrivateProfileInt("MASTERRESET", "Limit_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimit[2] = GetPrivateProfileInt("MASTERRESET", "Limit_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimit[3] = GetPrivateProfileInt("MASTERRESET", "Limit_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetLimitDay[0] = GetPrivateProfileInt("MASTERRESET", "LimitDay_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimitDay[1] = GetPrivateProfileInt("MASTERRESET", "LimitDay_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimitDay[2] = GetPrivateProfileInt("MASTERRESET", "LimitDay_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimitDay[3] = GetPrivateProfileInt("MASTERRESET", "LimitDay_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetLimitWek[0] = GetPrivateProfileInt("MASTERRESET", "LimitWek_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimitWek[1] = GetPrivateProfileInt("MASTERRESET", "LimitWek_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimitWek[2] = GetPrivateProfileInt("MASTERRESET", "LimitWek_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimitWek[3] = GetPrivateProfileInt("MASTERRESET", "LimitWek_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetLimitMon[0] = GetPrivateProfileInt("MASTERRESET", "LimitMon_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimitMon[1] = GetPrivateProfileInt("MASTERRESET", "LimitMon_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimitMon[2] = GetPrivateProfileInt("MASTERRESET", "LimitMon_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetLimitMon[3] = GetPrivateProfileInt("MASTERRESET", "LimitMon_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetStartLevel[0] = GetPrivateProfileInt("MASTERRESET", "StartLevel_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetStartLevel[1] = GetPrivateProfileInt("MASTERRESET", "StartLevel_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetStartLevel[2] = GetPrivateProfileInt("MASTERRESET", "StartLevel_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetStartLevel[3] = GetPrivateProfileInt("MASTERRESET", "StartLevel_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetStartReset[0] = GetPrivateProfileInt("MASTERRESET", "StartReset_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetStartReset[1] = GetPrivateProfileInt("MASTERRESET", "StartReset_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetStartReset[2] = GetPrivateProfileInt("MASTERRESET", "StartReset_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetStartReset[3] = GetPrivateProfileInt("MASTERRESET", "StartReset_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetPoint[0] = GetPrivateProfileInt("MASTERRESET", "Point_AL0", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetPoint[1] = GetPrivateProfileInt("MASTERRESET", "Point_AL1", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetPoint[2] = GetPrivateProfileInt("MASTERRESET", "Point_AL2", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetPoint[3] = GetPrivateProfileInt("MASTERRESET", "Point_AL3", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	this->m_CommandMasterResetPointRate[0] = GetPrivateProfileInt("MASTERRESET", "PointRateDW", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetPointRate[1] = GetPrivateProfileInt("MASTERRESET", "PointRateDK", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetPointRate[2] = GetPrivateProfileInt("MASTERRESET", "PointRateFE", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetPointRate[3] = GetPrivateProfileInt("MASTERRESET", "PointRateMG", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetPointRate[4] = GetPrivateProfileInt("MASTERRESET", "PointRateDL", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetPointRate[5] = GetPrivateProfileInt("MASTERRESET", "PointRateSU", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetPointRate[6] = GetPrivateProfileInt("MASTERRESET", "PointRateRF", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));
	this->m_CommandMasterResetPointRate[7] = GetPrivateProfileInt("MASTERRESET", "PointRateGL", 0, gPath.GetRightPath("Commands\\MasterReset.ini"));

	/************************************************************************************************************************************************/

	this->m_CommandClearInventoryEnable[0] = GetPrivateProfileInt("CLEARINVENTORY", "Enable_AL0", 0, gPath.GetRightPath("Commands\\ClearInventory.ini"));
	this->m_CommandClearInventoryEnable[1] = GetPrivateProfileInt("CLEARINVENTORY", "Enable_AL1", 0, gPath.GetRightPath("Commands\\ClearInventory.ini"));
	this->m_CommandClearInventoryEnable[2] = GetPrivateProfileInt("CLEARINVENTORY", "Enable_AL2", 0, gPath.GetRightPath("Commands\\ClearInventory.ini"));
	this->m_CommandClearInventoryEnable[3] = GetPrivateProfileInt("CLEARINVENTORY", "Enable_AL3", 0, gPath.GetRightPath("Commands\\ClearInventory.ini"));

	/**************************************************************************************************************************************************/

	GetPrivateProfileString("COIN", "ZenType", "", this->m_CommandCoinSyntaxZen, sizeof(this->m_CommandCoinSyntaxZen), gPath.GetRightPath("Commands\\Coin.ini"));
	GetPrivateProfileString("COIN", "GoblinPointType", "", this->m_CommandCoinSyntaxGP, sizeof(this->m_CommandCoinSyntaxGP), gPath.GetRightPath("Commands\\Coin.ini"));
	GetPrivateProfileString("COIN", "WCoinCType", "", this->m_CommandCoinSyntaxWC, sizeof(this->m_CommandCoinSyntaxWC), gPath.GetRightPath("Commands\\Coin.ini"));
	GetPrivateProfileString("COIN", "WCoinPType", "", this->m_CommandCoinSyntaxWP, sizeof(this->m_CommandCoinSyntaxWP), gPath.GetRightPath("Commands\\Coin.ini"));
	GetPrivateProfileString("COIN", "RuudType", "", this->m_CommandCoinSyntaxRuud, sizeof(this->m_CommandCoinSyntaxRuud), gPath.GetRightPath("Commands\\Coin.ini"));

	/*********************************************************************************************************************************************/

	this->m_CommandFillPotionEnable[0] = GetPrivateProfileInt("POTIONFILL", "Enable_AL0", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionEnable[1] = GetPrivateProfileInt("POTIONFILL", "Enable_AL1", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionEnable[2] = GetPrivateProfileInt("POTIONFILL", "Enable_AL2", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionEnable[3] = GetPrivateProfileInt("POTIONFILL", "Enable_AL3", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));

	this->m_CommandFillPotionMoney[0] = GetPrivateProfileInt("POTIONFILL", "MoneyTax_AL0", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionMoney[1] = GetPrivateProfileInt("POTIONFILL", "MoneyTax_AL1", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionMoney[2] = GetPrivateProfileInt("POTIONFILL", "MoneyTax_AL2", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionMoney[3] = GetPrivateProfileInt("POTIONFILL", "MoneyTax_AL3", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));

	this->m_CommandFillPotionGP[0] = GetPrivateProfileInt("POTIONFILL", "GoblinPoint_AL0", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionGP[1] = GetPrivateProfileInt("POTIONFILL", "GoblinPoint_AL1", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionGP[2] = GetPrivateProfileInt("POTIONFILL", "GoblinPoint_AL2", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionGP[3] = GetPrivateProfileInt("POTIONFILL", "GoblinPoint_AL3", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));

	this->m_CommandFillPotionWP[0] = GetPrivateProfileInt("POTIONFILL", "WCoinPTax_AL0", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionWP[1] = GetPrivateProfileInt("POTIONFILL", "WCoinPTax_AL1", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionWP[2] = GetPrivateProfileInt("POTIONFILL", "WCoinPTax_AL2", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionWP[3] = GetPrivateProfileInt("POTIONFILL", "WCoinPTax_AL3", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));

	this->m_CommandFillPotionWC[0] = GetPrivateProfileInt("POTIONFILL", "WCoinCTax_AL0", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionWC[1] = GetPrivateProfileInt("POTIONFILL", "WCoinCTax_AL1", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionWC[2] = GetPrivateProfileInt("POTIONFILL", "WCoinCTax_AL2", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionWC[2] = GetPrivateProfileInt("POTIONFILL", "WCoinCTax_AL2", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionWC[3] = GetPrivateProfileInt("POTIONFILL", "WCoinCTax_AL3", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));

	this->m_CommandFillPotionMaxAmount[0] = GetPrivateProfileInt("POTIONFILL", "MaxPotion_AL0", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionMaxAmount[1] = GetPrivateProfileInt("POTIONFILL", "MaxPotion_AL1", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionMaxAmount[2] = GetPrivateProfileInt("POTIONFILL", "MaxPotion_AL2", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
	this->m_CommandFillPotionMaxAmount[3] = GetPrivateProfileInt("POTIONFILL", "MaxPotion_AL3", 0, gPath.GetRightPath("Commands\\FillPotion.ini"));
}
...
void CServerInfo::ReadCommonInfo(char* section, char* path) // OK
{
	...
	this->m_NonDevilPK = GetPrivateProfileInt(section, "NonDevilPK", 0, path);
...
#endif
#if(GAMESERVER_UPDATE>=1000)//2017/04/01

	this->m_LevelUpPoint[7] = GetPrivateProfileInt(section, "FKLevelUpPoint", 0, path);
...
#endif
#if(GAMESERVER_UPDATE>=1000)////2017/02/28
	this->m_FKCreateLevel[0] = GetPrivateProfileInt(section, "FKCreateLevel_AL0", 0, path);

	this->m_FKCreateLevel[1] = GetPrivateProfileInt(section, "FKCreateLevel_AL1", 0, path);

	this->m_FKCreateLevel[2] = GetPrivateProfileInt(section, "FKCreateLevel_AL2", 0, path);

	this->m_FKCreateLevel[3] = GetPrivateProfileInt(section, "FKCreateLevel_AL3", 0, path);
#endif
	...
	this->m_MasterSkillTreeMinClass = GetPrivateProfileInt(section, "MasterSkillTreeMinClass", 0, path);
	this->m_MasterSkillTreeMaxLevel = GetPrivateProfileInt(section, "MasterSkillTreeMaxLevel", 0, path);


	this->m_ForMasterSkillTree = GetPrivateProfileInt(section, "ForMasterSkillTree", 0, path);
	this->m_ForMasterSkillTreePoint = GetPrivateProfileInt(section, "ForMasterSkillTreePoint", 0, path);
	this->m_ForMasterTreeMaxLevel = GetPrivateProfileInt(section, "ForMasterSkillTreeMaxLevel", 0, path);

	this->m_AddForMasterExperienceRate[0] = GetPrivateProfileInt(section, "AddForMasterExperienceRate_AL0", 0, path);
	this->m_AddForMasterExperienceRate[1] = GetPrivateProfileInt(section, "AddForMasterExperienceRate_AL1", 0, path);
	this->m_AddForMasterExperienceRate[2] = GetPrivateProfileInt(section, "AddForMasterExperienceRate_AL2", 0, path);
	this->m_AddForMasterExperienceRate[3] = GetPrivateProfileInt(section, "AddForMasterExperienceRate_AL3", 0, path);

	this->m_MinForMasterExperienceMonsterLevel[0] = GetPrivateProfileInt(section, "MinForMasterExperienceMonsterLevel_AL0", 0, path);
	this->m_MinForMasterExperienceMonsterLevel[1] = GetPrivateProfileInt(section, "MinForMasterExperienceMonsterLevel_AL1", 0, path);
	this->m_MinForMasterExperienceMonsterLevel[2] = GetPrivateProfileInt(section, "MinForMasterExperienceMonsterLevel_AL2", 0, path);
	this->m_MinForMasterExperienceMonsterLevel[3] = GetPrivateProfileInt(section, "MinForMasterExperienceMonsterLevel_AL3", 0, path);
	...
	this->m_BombHuntEventOn = GetPrivateProfileInt(section, "BombHuntEventOn", 0, path);
	...
	this->m_PotionMode = GetPrivateProfileInt(section, "PotionMode", 0, path);
	this->m_PotionModeDelay = GetPrivateProfileInt(section, "PotionModeDelay", 500, path);
	...
	this->m_LifeSuccessRateLuck[0] = GetPrivateProfileInt(section, "LifeSuccessRateLuck_AL0", 0, path);
	this->m_LifeSuccessRateLuck[1] = GetPrivateProfileInt(section, "LifeSuccessRateLuck_AL1", 0, path);
	this->m_LifeSuccessRateLuck[2] = GetPrivateProfileInt(section, "LifeSuccessRateLuck_AL2", 0, path);
	this->m_LifeSuccessRateLuck[3] = GetPrivateProfileInt(section, "LifeSuccessRateLuck_AL3", 0, path);
...
void CServerInfo::ReadEventInfo(char* section, char* path) // OK
{
	...
	this->m_CastleSiegeMaxMembersInTower = GetPrivateProfileInt(section, "CastleSiegeMaxMembersInTower", 999, path);
	...
	this->m_SilvesterEvent = GetPrivateProfileInt(section, "SilvesterEvent", 0, path);

	this->m_MagicMazeEvent = GetPrivateProfileInt(section, "MagicMazeEvent", 0, path);
}
...
void CServerInfo::ReadHackInfo(char* section, char* path) // OK
{
	...
	this->SpeedGenerateConfig = GetPrivateProfileInt(section, "AntiSpeedGenerateConfig", 0, path);
	GetPrivateProfileString(section, "AntiSpeedConfigCharacterToTest", "", this->CharacterToTest, sizeof(this->CharacterToTest), path); ;
	this->AntiSpeedEnable = GetPrivateProfileInt(section, "AntiSpeedEnable", 0, path);
	this->GenerateConfigTimer = GetPrivateProfileInt(section, "AntiSpeedConfigTimer", 1000, path);
	this->AgilityAutoIncrement = GetPrivateProfileInt(section, "AntiSpeedAgilityAutoIncrement", 10, path);

	this->FilaHit = GetPrivateProfileInt(section, "HitQueueEnable", 1, path);
	this->FilaHitGenerateConfig = GetPrivateProfileInt(section, "HitQueueGenerateConfig", 0, path);
	this->FilaHitAgiInc = GetPrivateProfileInt(section, "HitQueueAgilityAutoIncrement", 0, path);
	this->FilaHitCleanTime = GetPrivateProfileInt(section, "HitQueueCleanTime", 10, path);
	this->FilaHitLogProcesso = GetPrivateProfileInt(section, "HitQueueProcessLog", 0, path);
	GetPrivateProfileString(section, "HitQueueStalk", "x", this->FilaHitLogStalk, sizeof(this->FilaHitLogStalk), path);

	gSpeedFila.Load();

	this->BackSpringCheck = GetPrivateProfileInt(section, "BackSpringCheck", 0, path);
	this->BackSpringTolerance = GetPrivateProfileInt(section, "BackSpringTolerance", 0, path);
	this->BackSpringBlockTime = GetPrivateProfileInt(section, "BackSpringBlockTime", 0, path);
}
...
void CServerInfo::ReadSkillInfo(char* section, char* path) // OK
{
	...
	this->m_DefenseAbs = GetPrivateProfileInt(section, "DefenseAbs", 0, path);
	this->m_LifeAbs = GetPrivateProfileInt(section, "LifeAbs", 0, path);
	this->m_BastionConstA = GetPrivateProfileInt(section, "BastionConstA", 0, path);
	this->m_BastionConstB = GetPrivateProfileInt(section, "BastionConstB", 0, path);
	this->m_BleedingConst = GetPrivateProfileInt(section, "BleedingConst", 0, path);
	this->m_ParalyzingConst = GetPrivateProfileInt(section, "ParalyzingConst", 0, path);
	this->m_PunishConst = GetPrivateProfileInt(section, "PunishConst", 0, path);
	this->m_BlindingConst = GetPrivateProfileInt(section, "BlindingConst", 0, path);
	...
	this->m_ManaShieldRate[7] = GetPrivateProfileInt(section, "ManaShieldRateGL", 0, path);
	...
	this->m_GreaterDefenseRate[7] = GetPrivateProfileInt(section, "GreaterDefenseRateGL", 0, path);

	this->m_GreaterDefenseTimeConstA = GetPrivateProfileInt(section, "GreaterDefenseTimeConstA", 0, path);

	this->m_GreaterDefenseMax = GetPrivateProfileInt(section, "GreaterDefenseMax", 90, path);
	...
	this->m_GreaterDamageRate[7] = GetPrivateProfileInt(section, "GreaterDamageRateGL", 0, path);

	this->m_GreaterDamageTimeConstA = GetPrivateProfileInt(section, "GreaterDamageTimeConstA", 0, path);

	this->m_GreaterDamageMax = GetPrivateProfileInt(section, "GreaterDamageMax", 90, path);
	...
	this->m_GreaterLifeRate[7] = GetPrivateProfileInt(section, "GreaterLifeRateGL", 0, path);
	...
	this->m_GreaterCriticalDamageMax = GetPrivateProfileInt(section, "GreaterCriticalDamageMax", 90, path);
	...
	this->m_ReflectDamageRate[7] = GetPrivateProfileInt(section, "ReflectDamageRateGL", 0, path);
	...
	this->m_GreaterIgnoreDefenseMax				= GetPrivateProfileInt(section, "GreaterIgnoreDefenseMax", 10, path);
	...
	this->m_FitnessMax = GetPrivateProfileInt(section, "FitnessMax", 99999, path);
	...
	this->m_GreaterDefenseSuccessMax = GetPrivateProfileInt(section, "GreaterDefenseSuccessMax", 99, path);
	...
	this->m_CircleShieldValue = GetPrivateProfileInt(section, "CircleShieldValue", 50, path);
	this->m_CircleShieldCount = GetPrivateProfileInt(section, "CircleShieldCount", 4, path);

	this->m_ObsidianConst = GetPrivateProfileInt(section, "ObsidianConst", 0, path);
	this->m_ObsidianMax = GetPrivateProfileInt(section, "ObsidianMax", 90, path);
	this->m_ObsidianTimeConst = GetPrivateProfileInt(section, "ObsidianTimeConst", 0, path);

	this->m_WrathCutDefConst = GetPrivateProfileInt(section, "WrathCutDefConst", 0, path);
	this->m_WrathConst = GetPrivateProfileInt(section, "WrathConst", 0, path);
	this->m_WrathTimeConst = GetPrivateProfileInt(section, "WrathTimeConst", 0, path);

	this->m_ArchangelWillCount = GetPrivateProfileInt(section, "ArchangelWillCount", 0, path);
	this->m_ArchangelWillValue = GetPrivateProfileInt(section, "ArchangelWillValue", 0, path);

	this->DarkPhoenixShotDexDivisor = GetPrivateProfileInt(section, "DarkPhoenixShotDexDivisor", 10, path);
	this->DarkPhoenixShotDexSum = GetPrivateProfileInt(section, "DarkPhoenixShotDexSum", 50, path);
}
