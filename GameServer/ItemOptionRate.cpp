...
bool CItemOptionRate::MakeNewOption(int ItemIndex,int value,BYTE* option) // OK
{
	...
	if(
		...
		ItemIndex == GET_ITEM(12,269) ||
#endif
		(ItemIndex >= GET_ITEM(12,3) && ItemIndex <= GET_ITEM(12,6)) || ItemIndex == GET_ITEM(12,42) || ItemIndex == GET_ITEM(12,49) || ItemIndex == GET_ITEM(13,30)) // 2sd Wings
	{
	...
	if(
		#if(GAMESERVER_UPDATE>=1000)//2017/03/10
		ItemIndex == GET_ITEM(12,270) ||
#endif
		(ItemIndex >= GET_ITEM(12,36) && ItemIndex <= GET_ITEM(12,40)) || ItemIndex == GET_ITEM(12,43) || ItemIndex == GET_ITEM(12,50)) // 3rd Wings
	{
		MaxNewOption = 4;
	}
