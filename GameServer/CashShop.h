...
struct PMSG_CASH_SHOP_ITEM_USE_RECV_SXI
{
	PSBMSG_HEAD header;
	WORD ItemIndex;
};
...
struct PMSG_CASH_SHOP_ITEM_USE_SEND_SXI
{
	PSBMSG_HEAD header; //C1:D2:0F
	WORD item;
	BYTE unk;
};
//**********************************************//
...
public:
	...
	#if(GAMESERVER_UPDATE>=1100)//2017/04/21
	void CGCashShopItemUseRecvSXI(PMSG_CASH_SHOP_ITEM_USE_RECV_SXI* lpMsg,int aIndex);
#endif
private:
