...
void DGGlobalPopupRecv(SDHP_GLOBAL_POPUP_RECV* lpMsg);
...
void GDGlobalPopupSend(int MapServerGroup, char* message);
...
void GDPkInfoSaveSend(int aIndex);
...
void GDCustomMonsterRewardSaveSend(int aIndex,int MonsterClass,int MapNumber,int RewardValue1,int RewardValue2, int RewardValue3, int damage);
